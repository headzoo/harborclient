...
- **Plugins** — Extend HarborClient with installable `.hcp` packages (or load unpacked during development): custom settings panels, HTTP hooks, and persistent storage. See [Plugins](/plugins).
