    ...
    <div className="mb-6 flex flex-col gap-2">
      <div className="mb-6 flex flex-col gap-6">
        ...
        <p className="m-0 text-[14px] text-muted">
          API keys are encrypted and stored locally on this machine. HarborClient uses the OS
          keychain when available, or a local encryption key otherwise. They are not used by
          HarborClient yet.
        </p>
      </div>
